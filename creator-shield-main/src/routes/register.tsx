...
export const Route = createFileRoute("/register")({
  head: () => ({
    meta: [
      { title: "Create an Account | TubeCheck" },
      { name: "description", content: "Sign up for TubeCheck to protect your YouTube channels from monetization threats." },
    ],
  }),
...
function RegisterPage() {
  const { register, token, error: authError, loading, initialize } = useAuth();
  ...
  return (
    <div className="relative min-h-screen grid lg:grid-cols-12 bg-background transition-colors duration-300">
      ...
      {/* RIGHT COLUMN: Sign Up Card & Features Checklist */}
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Protect your creator network and secure monetization with TubeCheck.
            </p>
          </div>
